     ...
     if (ae.getSource()==b2)
        {
         try
         {
            ...
            conn c1= new conn();
            String query="select name,department , salary from employee where code='"+t1.getText()+"'";
         ...
         catch(Exception e)
         {
             ...
             String salary=t4.getText();
            conn c1= new conn();
            String query="update employee set name='"+name+"',department='"+department+"',salary='"+salary+"' where code='"+t1.getText()+"'";
