 ...
 */
public class update_cust extends JFrame implements ActionListener {
     ...
     if (ae.getSource()==b2)
        {
         ...
         catch(Exception e)
         {
             ...
             String email=t4.getText();
            conn c1= new conn();
            String query="update customer set name='"+name+"',phoneno='"+phoneno+"',email='"+email+"' where id='"+t1.getText()+"'";
