 ...
 */
public class del_cust extends JFrame implements ActionListener{
     ...
     if (ae.getSource()==b1)
        {
         try
         {
             ...
             conn c1= new conn();
             String sql="delete from customer where id='"+t1.getText()+"'";
         ...
         catch(Exception e)
         {
             ...
             String email= t4.getText();
             conn c1= new conn();
             String sql="select name,phoneno,email from customer where id='"+t1.getText()+"'";
